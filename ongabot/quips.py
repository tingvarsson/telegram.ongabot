...
POOLS: Dict[Banter, List[str]] = {
    ...
    # Sitting it out.
    Banter.FIRST_NO_OP: [
        "off to witness protection for the night",
        "saving energy for absolutely nothing",
        "opened the group chat just to say no",
        ...
        "one fewer headset on the call tonight",
        ...
        "choosing sleep over clutches",
        "leaving the lobby before it's even a lobby",
    ...
    Banter.GAME_TO_MAYBE: [
        ...
        "the schedule gods have spoken",
        "going from full buy to eco",
        "wait, what happened since that vote?",
    ...
    Banter.GAME_TO_NO_OP: [
        ...
        "from carry to couch in one click",
        ...
        "the voice chat just went quiet",
    ...
    Banter.MAYBE_TO_NO_OP: [
        ...
        "picked a side at last. We'll live.",
    ...
    Banter.RETRACTED_GAME: [
        ...
        "sent to the shadow realm, apparently",
        "now you see it, now you don't",
        "that vote had a short, happy life",
